...
* [xv6 中文註解源碼](../src/toc.md)
* [xv6 中文電子書](summary.md)

## 授權聲明

本版由陳鍾誠修改自 [xv6 中文文档](https://github.com/ranxian/xv6-chinese/) ，其專案網址為

* https://github.com/ranxian/xv6-chinese/

該文檔採用 [GNU GPL V3.0](http://www.gnu.org/copyleft/gpl.html) 釋出。
