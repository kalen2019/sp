 ...
 # -auxbase-strip loop_invariant_O3.s -O3 -fverbose-asm
...
_fsum:
	...
	testl	%esi, %esi	 # n
	jle	L4	 #,
	imull	%ebx, %ebx	 # x, D.1502
	xorl	%edx, %edx	 # i
	xorl	%eax, %eax	 # s
	.p2align 4,,10
L3:
	movl	%edx, %ecx	 # i, D.1502
	imull	%edx, %ecx	 # i, D.1502
	addl	$1, %edx	 #, i
	addl	%ebx, %ecx	 # D.1502, D.1502
	addl	%ecx, %eax	 # D.1502, s
	cmpl	%edx, %esi	 # i, n
	jne	L3	 #,
L2:
	popl	%ebx	 #
